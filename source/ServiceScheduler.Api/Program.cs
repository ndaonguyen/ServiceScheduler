...
using ServiceScheduler.Api.Security;
using ServiceScheduler.Application;
using ServiceScheduler.Application.Abstractions;
using ServiceScheduler.Infrastructure;
...
// Serve the React SPA built into wwwroot (see ServiceScheduler.Api.csproj publish target).
app.UseDefaultFiles();
app.UseStaticFiles();
